...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="height: 552px">
        ...
        <asp:Button ID="registerButton" runat="server" Text="Register" ValidationGroup='register' style="position:absolute; top: 585px; left: 228px;" OnClick="registerButton_Click"/>
