...
namespace FoodStoreV2.CSharpClasses
{
    public class VerifyReCaptcha
    {
        ...
        public bool verifyCapcha(String gRecaptchaResponse)
        {
            ...
            var googleReply = client.DownloadString(string.Format(siteToVerify, secretKey, gRecaptchaResponse));
            var serializer = new System.Web.Script.Serialization.JavaScriptSerializer();
            var reCaptcha = serializer.Deserialize<VerifyReCaptcha>(googleReply);
